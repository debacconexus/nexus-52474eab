...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "High-Acuity Crisis & Housing Dispatch System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Crisis Dispatch Incident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "crisis_dispatch_incident_records";
'use strict';
